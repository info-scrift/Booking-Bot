...
//     if (!profileId || typeof isPaid !== "boolean") {
//       return new Response(JSON.stringify({ error: "Invalid request payload" }), {
//         status: 400,
//         headers: { "Content-Type": "application/json" },
//       })
...
//     if (isPaid && profile.phone_number) {
//       const amount = Number(profile.maintenance_charges ?? 0).toLocaleString("en-PK")
//       const message = [
//         `Hello ${profile.name || "Resident"},`,
//         `Your maintenance account has been marked as PAID.`,
//         `Amount received: Rs. ${amount}. Thank you for keeping your dues current.`,
//         "- Green Three",
//       ].join("\n")
